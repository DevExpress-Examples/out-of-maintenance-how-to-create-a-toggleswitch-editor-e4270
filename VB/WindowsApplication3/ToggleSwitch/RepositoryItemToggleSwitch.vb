...
Namespace WindowsApplication3
	...
	Public Class RepositoryItemToggleSwitch
		...
		Public Sub New()
            ...
            MyBase.PictureUnchecked = ResourceImageHelper.CreateImageFromResources("ToggleSwitchOff.png", GetType(RepositoryItemToggleSwitch).Assembly)
            MyBase.PictureChecked = ResourceImageHelper.CreateImageFromResources("ToggleSwitchOn.png", GetType(RepositoryItemToggleSwitch).Assembly)
            MyBase.PictureGrayed = ResourceImageHelper.CreateImageFromResources("ToggleSwitchDisabled.png", GetType(RepositoryItemToggleSwitch).Assembly)
		End Sub
